  ...
  <div class="zhsq-innerBody" ref="innerBody">
    <div class="zhsq-innerTop flex">
      ...
      <div class="flexItem text_r">
        ...
        <el-button type="primary" size="small" @click="editRow()" v-allow="600100101">新增</el-button>
        <el-button type="primary" size="small" @click="importFormVisible = true" v-allow="600100104">导入</el-button>
        <el-button type="primary" size="small" ><a href="/template/vehicle.xlsx">下载模板</a></el-button>
      </div>
    </div>
              ...
              <el-table :data="tableData" style="width: 100%" stripe   >
                ...
                <el-table-column  label="操作" align='center' width="150">
                  <template slot-scope="scope">
                    <el-button type="primary" size="mini"    @click="editRow(scope.row)" v-allow="600100102">编辑</el-button>
                    <el-button type="danger"  size="mini"  @click="deleteRow(scope.row)" v-allow="600100103">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
              <div class="pageBox">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        action:myConfig.baseUrl+'/business/cvehicle/import',
        importVisible:false,
        importData:[],
        fileList:[],
        fileHeader:{},
