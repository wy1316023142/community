<template>
  <div class="zhsq-innerBody" ref="innerBody">
    ...
    <el-dialog  title="关注人员选择" :visible.sync="concernPerson"
  ...
  export default {
    ...
    methods: {
      ...
      _fetchData: debounce(async function() {
        const data = await Api.peopleList.get(this.filter, {
      ...
      add(){
        this.addData.orgId=this.$route.params.organId
        this.concernPerson=true
        this.addList()
      },
       async addList(){
           const data = await Api.orgPeopleList.get(this.addData, {
          loadingMaskTarget: '.tableShow'
        }).then(res => res.data)
