<template>
  <div class="zhsq-innerBody" ref="innerBody">
      ...
      <span class="title">消防栓告警记录</span>
       ...
       <div class="text_r flexItem">
        ...
        <el-select v-model="filter.alarmType2" placeholder="报警内容" clearable>
          <el-option label="取水告警" value="706"></el-option>
          <el-option label="关水告警" value="705"></el-option>
          <el-option label="开盖告警" value="704"></el-option>
          <el-option label="低电量告警" value="707"></el-option>
        </el-select>
    ...
    <el-dialog  title="消防栓报警" :visible.sync="alarmRecord" :close-on-press-escape="false" :modal-append-to-body='false' width="400px" top="5vh">
      <el-form>
