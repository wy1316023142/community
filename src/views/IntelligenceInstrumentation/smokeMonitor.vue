  ...
  <div class="zhsq-innerBody" ref="innerBody">
    <div class="zhsq-innerTop flex">
      ...
      <div class="flexItem text_r">
        ...
        <el-input type="text" placeholder="设备编号" v-model="filter.machineNumber" clearable></el-input>
         <el-select v-model="filter.layerResourceTypeId" placeholder="通讯状态" clearable>
        ...
        <el-button type="primary" size="small" @click="addDialogForm" v-allow="700300301">新增</el-button>
      </div>
    </div>
              ...
              <el-table :data="tableData" style="width: 100%" stripe :height='tabHeight' :max-height="tabHeight">
                ...
                <el-table-column label="操作" align='center' width='150px'>
                  <template slot-scope="scope">
                    <el-button type="primary" size="mini" @click="editRow(scope.row)" v-allow="700300302">编辑</el-button>
                    <el-button type="danger" size="mini" @click="deleteRow(scope.row)" v-allow="700300303">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
              <div class="pageBox">
    ...
    <el-dialog :title="dialogFormTitle" :visible.sync="addDialogFormVisible" :close-on-press-escape="false"
      ...
      <el-form ref="form" :model="model" :rules="rules" :show-message="false">
        ...
        <el-form-item label="设备编号：" prop="resourceType">
  ...
  export default {
    ...
    methods: {
      _fetchData: debounce(async function () {
        const data = await Api.pagingDeviceSmoke.get(this.filter, {
        ...
        this.$refs.form.validate(async (valid, invalidFields) => {
          if (valid) {
            ...
            if (!this.model.id) {
              ...
              this.model.organId = this.filter.organId;
              await Api.addDeviceSmoke.post(this.model)
                .then(() => {
              ...
              await Api.editDeviceSmoke.put(this.model, {
                pathParams: {
                  id: this.model.id
                }
              }).then(() => {
      ...
      async deleteRow(row) {
        this.$confirm(`确定删除吗？`, '提示', {
          ...
          const data = await Api.deleteDeviceSmoke.delete({}, {
            pathParams: {
              id: row.id
            }
          }).then(res => {
